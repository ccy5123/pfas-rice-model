...
def main(fast=False):
    ...
    print("   The alternative is kept RUNNABLE rather than buried here, in the repo's")
    print("   idiom for an open question: model_api.simulate(uptake='bypass'), with")
    print("   'carrier' the default and bit-identical to the shipped model.")
