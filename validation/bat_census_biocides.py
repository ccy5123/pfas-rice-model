...
def verdict(rows, screened, runs, ov, fig_path=None):
    ...
    print("  -- those arrived with no BPC class and no fish BCF, and the project later supplied")
    print("  both, which is what took the rank correlation from 20 substances to 60 -- 1 from")
